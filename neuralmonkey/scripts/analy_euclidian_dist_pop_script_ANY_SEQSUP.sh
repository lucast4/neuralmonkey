...
#  datelist=(230922 230920 230924 230925) # 9/21 failing.
...
#  datelist=(230923 231019 231020) # Remaining, not yet run (8/25/24)
 datelist=(230920 230921) # Remaining, not yet run (8/25/24)
