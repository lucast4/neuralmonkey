...
DEBUG=False
# PREFIX_SAVE_BASE = "rulesgoodfinal" # min spike magn 90, and removing low fr
# PREFIX_SAVE_BASE = "rulesgoodfinalmoreunits" # no remove low fr. remove low spikes <80.
PREFIX_SAVE_BASE = "shapeloc_removeonlylowmagnspikes" # no remove low fr. remove low spikes <80.
...
for DATE in LIST_DATE:
    for DATASET_PRUNE_SAME_BEH_ONLY, FIRST_STROKE_SAME in LIST_SAME_FIRST:
    ...
    #   for FIRST_STROKE_SAME in LIST_FIRST_STROKE_SAME:
        ...
        # print(DATASET_PRUNE_SAME_BEH_ONLY, FIRST_STROKE_SAME)
        # assert False
        animal = "Pancho"
        ...
        for sess in SESSIONS:
            ...
            if QUESTION in ["motor", "stroke"]:
                ...
                DS = datasetstrokes_extract(sn.Datasetbeh, strokes_only_keep_single,
                                            ...
                                            prune_feature_levels_min_n_trials, list_possible_features_datstrokes)
                if len(DS.Dat)<50:
                    continue

                # check which features exist
                list_features_extraction = []
                for feat in list_possible_features_datstrokes:
